System.register(["angular2/core", "angular2/router", "../services/article.service", '../pipes/truncate.pipe', '../pipes/capitalize-first-letter.pipe', '../pipes/capitalize.pipe'], function(exports_1) {
